...
def get_params():
    ...
    parser.add_argument("--n_skills", default=10, type=int, help="The number of skills to learn.")
    ...
    #  Parameters optimized for Atari environments
    # region default parameters
    default_params = {
                  
                    "lr": 3e-4,
                    "batch_size": 256,
                    "max_n_episodes": 2000,  # Reduced for faster testing
                    "max_episode_len": 500,   # Reduced episode length for Atari
                    "gamma": 0.99,
                    "alpha": 0.1,
                    "tau": 0.005,
                    "n_hiddens": 256  # Slightly smaller network for faster training
                      }
    # endregion
