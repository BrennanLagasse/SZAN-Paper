...
class Logger:
    ...
    def log(self, *args):
        ...
        save_interval = max(1, self.config["interval"] // 3)
    ...
    def load_weights(self):
        ...
        model_dir.sort()
        checkpoint_path = model_dir[-1] + "params.pth"
        checkpoint = torch.load(checkpoint_path, weights_only=False)
        self.log_dir = model_dir[-1].split(os.sep)[-2]  # Get the directory name without trailing slash
